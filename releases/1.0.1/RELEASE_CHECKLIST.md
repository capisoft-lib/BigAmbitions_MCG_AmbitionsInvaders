# Ambitions Invaders 1.0.1 publication checklist
...
- [ ] Compile with the actual MCG 1.0.1+ DLL and matching manifest; check versions and hashes in the ignored build status file.
- [ ] Verify manifest/catalog version 1.0.1, assembly/file version 1.0.1.0, stable technical IDs and record ruleset.
...
- [ ] Add [LIB MCG — Workshop item 3793604724](https://steamcommunity.com/sharedfiles/filedetails/?id=3793604724) to **Required Items**. No other mod library is required. Keep the Workshop link and mandatory MCG 1.0.1+ installation/activation warning in both descriptions; Required Items do not enforce semantic versions.
