...
try {
    ...
    if (!$versionField -or [version]$versionField.Constant -lt [version]'0.2.0') { throw 'MCG API 0.2.0 or later is required.' }
}
...
foreach ($name in @('README.md','REQUIRED_MODS.md','ART_PROVENANCE.md','VERIFICATION.md','LICENSE','ModManifest.asset')) {
